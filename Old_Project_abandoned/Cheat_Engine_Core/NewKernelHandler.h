...
#ifndef NewKernelhandler_H
#define NewKernelhandler_H
...
public:
	...
	BOOL ReadProcessMemory(HANDLE hProcess, LPVOID lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T* lpNumberOfBytesRead);
	...
	BOOL VirtualToPhysicalCR3(SIZE_T cr3, SIZE_T VirtualAddress, SIZE_T PhysicalAddress);
	BOOL ReadProcessMemoryCR3(SIZE_T cr3, LPCVOID lpBaseAddress, LPVOID lpBuffer, SIZE_T nSize, SIZE_T* lpNumberOfBytesRead);
	BOOL WriteProcessMemoryCR3(SIZE_T cr3, LPCVOID lpBaseAddress, LPCVOID lpBuffer, SIZE_T nSize, SIZE_T* lpNumberOfBytesWritten);
	SIZE_T VirtualQueryExCR3(SIZE_T cr3, LPCVOID lpAddress, PMEMORY_BASIC_INFORMATION lpBuffer, SIZE_T dwLength);

	BOOL GetPageInfoCR3(SIZE_T cr3, SIZE_T VirtualAddress, PMEMORY_BASIC_INFORMATION lpBuffer);
	BOOL GetNextReadablePageCR3(SIZE_T cr3, SIZE_T VirtualAddress, LPVOID ReadableVirtualAddress);
#endif
	...
	dbk32functions* dbk32functions1 = new dbk32functions();


	//plugin* pluginhandler = new plugin();
	...
	SIZE_T pageEntryToProtection(SIZE_T entry);
