...
namespace {
struct qt_meta_tag_ZN13ProcessDialogE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13ProcessDialogE = QtMocHelpers::stringData(
    "ProcessDialog"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ProcessDialogE[] = {
...
Q_CONSTINIT const QMetaObject ProcessDialog::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ProcessDialogE.offsetsAndSizes,
    qt_meta_data_ZN13ProcessDialogE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ProcessDialogE_t,
        // Q_OBJECT / Q_GADGET
...
void *ProcessDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ProcessDialogE.stringdata0))
